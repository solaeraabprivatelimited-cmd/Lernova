import svgPaths from "./svg-lzjckeuivp";
...
export default function LiveModeDisableVideo() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Live Mode - Disable Video">
      <Frame54 />
      <Frame1 />
      <Frame33 />
    </div>
