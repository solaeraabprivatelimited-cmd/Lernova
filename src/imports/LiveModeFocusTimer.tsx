import svgPaths from "./svg-djp4ha4ku0";
      ...
      <div className="absolute inset-[-3.75%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28.6667 28.6667">
          <g id="Group">
            ...
            <path d={svgPaths.p28f292e0} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </g>
        </svg>
      </div>
    </div>
...
function Group1() {
  return (
    <div className="absolute inset-[8.33%_12.5%_0.77%_12.5%]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.5 16.3598">
        <g id="Group">
          <g id="Vector"></g>
...
function FocusTimer() {
  return (
    <div className="absolute bg-[rgba(247,247,247,0.2)] h-[722px] left-[944px] overflow-clip rounded-[20px] top-[62px] w-[462px]" data-name="Focus Timer">
      <Frame15 />
    </div>
  );
}
...
export default function LiveModeFocusTimer() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Live Mode - Focus Timer">
      <Frame1 />
      <FocusTimer />
      <Frame39 />
    </div>
