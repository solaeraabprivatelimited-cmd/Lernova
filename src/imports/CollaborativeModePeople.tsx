import svgPaths from "./svg-aukakkqcix";
...
export default function CollaborativeModePeople() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode - People">
      <Frame1 />
      <People />
      <Frame20 />
    </div>
