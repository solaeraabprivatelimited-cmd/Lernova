import svgPaths from "./svg-x88i2k0erj";
...
function Group() {
  return (
    <div className="absolute inset-[19.4%_28.99%_12.5%_20.83%]" data-name="Group">
      <div className="absolute inset-[0_-2.97%_-2.2%_-2.97%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35.6189 46.6248">
          <g id="Group">
            <path d={svgPaths.p11c0ecb0} fill="var(--fill-0, #003566)" id="Vector" />
            <path d={svgPaths.p168ffd40} id="Vector_2" stroke="var(--stroke-0, #003566)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </g>
        </svg>
      </div>
    </div>
...
function LetsIconsMicFill() {
  return (
    <div className="overflow-clip relative shrink-0 size-[67px]" data-name="lets-icons:mic-fill">
      <Group />
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="bg-white content-stretch flex items-center justify-center relative rounded-[100px] shadow-[0px_4px_60px_0px_rgba(0,0,0,0.1)] shrink-0 size-[105px]">
      <LetsIconsMicFill />
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[24px] items-center left-[318px] overflow-clip px-[455px] py-[36px] rounded-[12px] shadow-[0px_4px_60px_5px_rgba(0,0,0,0.15)] top-[640px] w-[1082px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-[rgba(0,0,0,0.6)] whitespace-nowrap">
        <p className="leading-[normal]">Ask me anything</p>
      </div>
      <Frame15 />
    </div>
  );
...
export default function MoodCheckInOnMic() {
  return (
    <div className="bg-white relative size-full" data-name="Mood Check-In  -  On Mic">
      <Frame8 />
      <Frame14 />
      <Frame13 />
