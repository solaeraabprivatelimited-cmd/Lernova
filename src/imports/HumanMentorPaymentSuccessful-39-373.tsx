import svgPaths from "./svg-tvqnfwsiri";
  ...
  return (
    <div className="h-[243.099px] relative shrink-0 w-[254px]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 254 243.099">
        <g id="Group">
          <path d={svgPaths.p6221200} fill="var(--fill-0, #70AF53)" id="Vector" />
          <path d={svgPaths.p315db580} fill="var(--fill-0, white)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center p-[24px] relative shrink-0 w-[640px]">
      <p className="css-4hzbpn font-['Poppins:SemiBold',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[24px] text-black w-[min-content]">Payment Successful</p>
      <Group4 />
      <p className="css-4hzbpn font-['Poppins:Medium',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[20px] text-black text-center w-[min-content]">Your session has been successfully booked.</p>
      <p className="css-4hzbpn font-['Poppins:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[16px] text-black text-center w-[min-content]">You’ll receive a notification before 10 minutes of your scheduled session time. Get ready to learn with your mentor!</p>
    </div>
  );
}
