import svgPaths from "./svg-xte1nbiim9";
...
export default function LiveModeRoomSilentNotifications() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Live Mode Room - Silent Notifications">
      <Frame1 />
      <Frame54 />
      <Frame33 />
      <Frame50 />
