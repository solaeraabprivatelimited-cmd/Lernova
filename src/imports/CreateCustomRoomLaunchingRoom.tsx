import svgPaths from "./svg-e3ici8y0e";
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex items-center left-[670px] top-[430px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-nowrap">Launching your room.......Please wait</p>
...
export default function CreateCustomRoomLaunchingRoom() {
  return (
    <div className="bg-white relative size-full" data-name="Create Custom Room - Launching Room">
