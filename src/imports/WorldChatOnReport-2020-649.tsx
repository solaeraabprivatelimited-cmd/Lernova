import svgPaths from "./svg-araiion8h5";
...
import imgEllipse2 from "figma:asset/1d3b37310d86db33d00fb05038f712cfa0e01556.png";

function Frame8() {
  return (
    <div className="absolute content-stretch flex flex-col items-start leading-[normal] left-[318px] not-italic pb-[6px] top-[98px]">
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.6)]">{`< Emotional Wellness`}</p>
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 text-[40px] text-black">World Chat</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="h-[40px] relative rounded-[12px] shadow-[0px_4px_60px_5px_rgba(0,0,0,0.15)] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[16px] relative size-full">
          <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.7)]">Hey, there everyone</p>
        </div>
      </div>
    </div>
  );
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[3px] items-start min-h-px min-w-px relative">
      <p className="font-['Poppins:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[12px] text-[rgba(0,0,0,0.6)] w-full whitespace-pre-wrap">
        <span className="leading-[normal] text-black">Alex</span>
        <span className="leading-[normal]">{` | 10:14PM`}</span>
      </p>
      <Frame13 />
    </div>
  );
...
function Frame30() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[64px] items-end left-[318px] top-[197px] w-[1082px]">
...
function Frame14() {
  return (
    <div className="h-[40px] relative rounded-[12px] shadow-[0px_4px_60px_5px_rgba(0,0,0,0.15)] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(201, 229, 255) 0%, rgb(201, 229, 255) 100%)" }}>
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[16px] relative size-full">
          <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.7)]">Hey, there everyone</p>
        </div>
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[3px] items-start min-h-px min-w-px relative">
      <p className="font-['Poppins:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[12px] text-[rgba(0,0,0,0.6)] text-right w-full whitespace-pre-wrap">
        <span className="leading-[normal] text-black">You</span>
        <span className="leading-[normal]">{` | 10:14PM`}</span>
      </p>
      <Frame14 />
    </div>
...
function Frame31() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[64px] items-end left-[318px] top-[341px] w-[1082px]">
      <Frame32 />
      <div className="relative shrink-0 size-[38px]">
        <img alt="" className="absolute block max-w-none size-full" height="38" src={imgEllipse1} width="38" />
      </div>
...
function Frame33() {
  return (
    <div className="flex-[1_0_0] h-[54px] min-h-px min-w-px relative rounded-[12px] shadow-[0px_4px_60px_5px_rgba(0,0,0,0.15)]" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[15px] relative size-full">
          <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.6)] whitespace-nowrap">
            <p className="leading-[normal]">Type here</p>
          </div>
        </div>
      </div>
    </div>
...
function MaskGroup() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute contents left-[calc(50%+2px)] top-1/2" data-name="Mask group">
...
function Frame35() {
  return (
    <div className="absolute content-stretch flex gap-[20px] items-center left-[318px] top-[859px] w-[1082px]">
      <Frame33 />
      <Frame34 />
    </div>
  );
...
function Frame15() {
  return (
    <div className="absolute h-[40px] left-[318px] rounded-[12px] shadow-[0px_4px_60px_5px_rgba(0,0,0,0.15)] top-[277px] w-[147px]" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center p-[24px] relative size-full">
          <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#ff5e5e] text-[12px]">Report</p>
        </div>
      </div>
    </div>
  );
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-start leading-[normal] not-italic relative shrink-0 text-black w-full whitespace-pre-wrap">
      <p className="font-['Poppins:SemiBold',sans-serif] relative shrink-0 text-[24px] w-full">Report User</p>
...
function Frame17() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <Frame16 />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-black">Inappropriate visuals or gestures</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0 w-full">
      ...
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-black">Camera showing disturbing or distracting content</p>
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      ...
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-black">Using unrelated or misleading video feed</p>
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center justify-center left-0 top-0">
      ...
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-black">Other</p>
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="absolute bg-[#d9d9d9] h-[127px] left-[24px] overflow-clip rounded-[20px] top-[29px] w-[352px]">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[normal] left-[16px] not-italic text-[12px] text-[rgba(0,0,0,0.7)] top-[16px]">Describe the issue briefly</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[42px] relative rounded-[20px] shrink-0 w-[156px]">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[35px] py-[3px] relative rounded-[inherit] size-full">
        <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-black">Cancel</p>
      </div>
...
function Frame26() {
  return (
    <div className="bg-[#ff5e5e] content-stretch flex h-[42px] items-center justify-center overflow-clip px-[35px] py-[3px] relative rounded-[20px] shrink-0 w-[156px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-white">{`Submit `}</p>
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="content-stretch flex gap-[16px] items-center justify-end relative shrink-0 w-[387px]">
      <Frame25 />
      <Frame26 />
    </div>
  );
...
function ReportUser() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white h-[454px] left-1/2 overflow-clip rounded-[20px] shadow-[0px_4px_60px_5px_rgba(0,0,0,0.15)] top-[calc(50%+0.5px)] w-[436px]" data-name="Report User">
      <Frame28 />
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex gap-[10px] h-[42px] items-center justify-center relative rounded-[10px] shrink-0 w-full">
      <div className="relative shrink-0 size-[38px]">
        <img alt="" className="absolute block max-w-none size-full" height="38" src={imgEllipse2} width="38" />
      </div>
...
export default function WorldChatOnReport() {
  return (
    <div className="relative size-full" data-name="World Chat - On Report" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Frame8 />
      <Frame30 />
      <Frame31 />
      <Frame35 />
      <Frame15 />
      <ReportUser />
      <div className="absolute bottom-0 h-[953px] left-0 pointer-events-none top-0">
        <Frame1 />
      </div>
      <Frame12 />
    </div>
