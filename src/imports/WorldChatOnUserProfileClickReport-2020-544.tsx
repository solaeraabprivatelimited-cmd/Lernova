import svgPaths from "./svg-ikt7mom72n";
...
export default function WorldChatOnUserProfileClickReport() {
  return (
    <div className="bg-white relative size-full" data-name="World Chat - On User Profile Click (report)">
      <Frame8 />
      <Frame17 />
      <Frame18 />
      <Frame22 />
