import svgPaths from "./svg-7xbozaw5jo";
...
function Frame28() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-[172px]">
      <Frame27 />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-nowrap text-white">Elizabeth (You) (Admin)</p>
    </div>
  );
}
...
function Frame31() {
  return (
    <div className="h-[38px] relative rounded-[20px] shrink-0 w-[163px]">
      <div className="content-stretch flex items-center justify-center overflow-clip px-0 py-[12px] relative rounded-[inherit] size-full">
        <p className="font-['Poppins:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#ff5e5e] text-[14px] text-nowrap">Report Member</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#ff5e5e] border-solid inset-0 pointer-events-none rounded-[20px]" />
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="bg-[#ff5e5e] content-stretch flex h-[38px] items-center justify-center overflow-clip px-0 py-[12px] relative rounded-[20px] shrink-0 w-[163px]">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-nowrap text-white">Kick Member</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(255,255,255,0.1)] relative rounded-[20px] shrink-0 w-full">
      <div className="flex flex-col items-end overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[14px] items-end px-[19px] py-[12px] relative w-full">
          <Frame56 />
          <Frame31 />
          <Frame11 />
        </div>
...
export default function CollaborativeModePeopleOptionsForAdmin() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode - People - Options for Admin">
      <Frame1 />
      <People />
      <Frame21 />
    </div>
