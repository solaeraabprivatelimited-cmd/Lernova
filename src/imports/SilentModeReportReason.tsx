import svgPaths from "./svg-bv672dabks";
...
export default function SilentModeReportReason() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Silent Mode- Report Reason">
      <Frame1 />
      <Frame54 />
      <Frame33 />
      <Frame50 />
