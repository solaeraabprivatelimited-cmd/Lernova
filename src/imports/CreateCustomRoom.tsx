import svgPaths from "./svg-r9h2tu6cre";
    ...
    <div className="h-[39px] relative rounded-[10px] shrink-0 w-full" data-name="Email Typist">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[10px] py-0 relative size-full">
          <CilRoom />
          <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.6)] text-nowrap">Name your study space</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="h-[39px] relative rounded-[10px] shrink-0 w-full" data-name="Email Typist">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[10px] py-0 relative size-full">
          <UilSubject />
          <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.6)] text-nowrap">Enter Subject/Topic</p>
        </div>
      </div>
    </div>
  );
...
export default function CreateCustomRoom() {
  return (
    <div className="bg-white relative size-full" data-name="Create Custom Room">
