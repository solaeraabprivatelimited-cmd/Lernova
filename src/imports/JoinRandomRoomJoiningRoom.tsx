import svgPaths from "./svg-zq1e3g82ms";
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex items-center left-[697px] top-[calc(50%+0.5px)] translate-y-[-50%]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-nowrap">Joining room.......Please wait</p>
      <div className="relative shrink-0 size-[39px]" data-name="hourglass 1">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgHourglass1} />
      </div>
    </div>
  );
}

export default function JoinRandomRoomJoiningRoom() {
  return (
    <div className="bg-white relative size-full" data-name="Join Random Room - Joining Room">
