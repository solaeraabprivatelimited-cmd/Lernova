import svgPaths from "./svg-7rmr01j40r";
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="temaki:room">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_2005_89)" id="temaki:room">
...
function Frame9() {
  return (
    <div className="absolute content-stretch flex flex-col items-start leading-[normal] left-[318px] not-italic pb-[6px] top-[98px]">
      ...
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 text-[40px] text-black">Mood Check-In</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex gap-[20px] items-start left-[318px] top-[806px] w-[1082px]">
      <Frame12 />
      <Frame13 />
    </div>
  );
...
function Frame16() {
  return (
    <div className="-translate-y-1/2 absolute h-[326px] left-[626px] top-1/2 w-[463px]">
      <div className="-translate-x-1/2 absolute bottom-[22.7%] left-1/2 top-0 w-[145px]" data-name="say hi 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[108.77%] left-[-32.4%] max-w-none top-[-8.59%] w-[186.39%]" src={imgSayHi1} />
        </div>
      </div>
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[1.3] left-[calc(50%-0.5px)] not-italic text-[32px] text-[rgba(0,0,0,0.7)] text-center top-[294px] whitespace-nowrap">
        <p className="mb-0">Hello, Jack Sparrow</p>
...
export default function MoodCheckIn() {
  return (
    <div className="bg-white relative size-full" data-name="Mood Check-In">
