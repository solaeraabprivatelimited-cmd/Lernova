import svgPaths from "./svg-2vqsdn872w";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[42px] items-center justify-center min-h-px min-w-px relative rounded-[20px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(0,0,0,0.8)]">Requests</p>
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] h-[42px] items-center justify-center min-h-px min-w-px relative rounded-[20px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-black">Upcoming</p>
    </div>
  );
}
...
function BasilArrowRightOutline() {
  return (
    <div className="relative shrink-0 size-[22px]" data-name="basil:arrow-right-outline">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
        <g id="basil:arrow-right-outline">
          <path d={svgPaths.p2da68b00} fill="var(--fill-0, black)" fillOpacity="0.6" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame37() {
  return (
    <div className="bg-[#c8c8c8] content-stretch flex items-center justify-center px-[16px] py-[4px] relative rounded-[20px] shrink-0">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(0,0,0,0.6)]">Join Session</p>
...
function BasilArrowRightOutline1() {
  return (
    <div className="relative shrink-0 size-[22px]" data-name="basil:arrow-right-outline">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
        <g id="basil:arrow-right-outline">
          <path d={svgPaths.p2da68b00} fill="var(--fill-0, #003566)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame39() {
  return (
    <div className="bg-[#c9e5ff] content-stretch flex items-center justify-center px-[16px] py-[4px] relative rounded-[20px] shrink-0">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#003566] text-[12px]">Join Session</p>
      <BasilArrowRightOutline1 />
    </div>
  );
}
...
export default function Upcoming() {
  return (
    <div className="bg-white relative size-full" data-name="Upcoming">
      <Frame34 />
      <Frame38 />
      <Frame8 />
      <p className="absolute font-['Poppins:Medium',sans-serif] h-[60px] leading-[0] left-[318px] not-italic text-[12px] text-black top-[505px] w-[1082px] whitespace-pre-wrap">
        <span className="leading-[normal]">* Note:</span>
        <span className="font-['Poppins:Regular',sans-serif] leading-[normal]">{` You’ll be able to join your session 10 minutes before the scheduled time. You’ll also receive a reminder notification when it’s time to join. `}</span>
      </p>
