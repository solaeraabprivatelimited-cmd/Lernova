import svgPaths from "./svg-k8a43tdlq8";
...
import imgImage16 from "figma:asset/96561b5363ed6c4b01aedeb5a19d6daa38ce5958.png";
...
import imgFrame427318274 from "figma:asset/b6dccc6e18e0a9b5c8a4572c3072d1ac8787242a.png";
...
function Frame1() {
  return (
    <div className="absolute bg-[#c4c4c4] h-[217px] left-[32px] overflow-clip rounded-[20px] top-[66px] w-[225px]">
      <MjusicFrame />
      <div className="absolute h-[217px] left-[-88px] top-0 w-[386px]" data-name="image 15">
...
function Frame56() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[478px] px-0 py-[2px] rounded-[20px] top-[655px] w-[101px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.6)] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-nowrap">Steve</p>
    </div>
  );
}
...
function PinUnpin() {
  return (
    <div className="relative shrink-0 size-[27px]" data-name="Pin, Unpin">
      <div className="absolute inset-[-2.06%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 27 27.557">
          <g id="Pin, Unpin">
            <path d={svgPaths.p3494c00} id="Vector" stroke="var(--stroke-0, #FF5E5E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.62" />
            <line id="Line 18" stroke="var(--stroke-0, #FF5E5E)" strokeLinecap="round" strokeWidth="1.08" x1="0.763487" x2="24.823" y1="0.540001" y2="23.5535" />
          </g>
        </svg>
      </div>
    </div>
...
function HugeiconsPin() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.4)] content-stretch flex items-center justify-center left-[18px] overflow-clip rounded-[20px] size-[47px] top-[17px]" data-name="hugeicons:pin">
      <PinUnpin />
    </div>
  );
}
...
function Frame55() {
  return (
    <div className="absolute bg-[#c4c4c4] h-[715px] left-[289px] overflow-clip rounded-[20px] top-[66px] w-[611px]">
      <MjusicFrame1 />
      <div className="absolute h-[718px] left-[-304px] top-0 w-[915px]" data-name="image 15">
...
function HugeiconsPin1() {
  return (
    <div className="absolute left-[12px] size-[34px] top-[12px]" data-name="hugeicons:pin">
...
function MjusicFrame2() {
  return (
    <div className="absolute bg-[rgba(20,19,22,0.2)] content-stretch flex gap-[24px] items-start left-[940px] opacity-0 overflow-clip pl-[32px] pr-[24px] py-[16px] rounded-[20px] top-[12px]" data-name="Mjusic Frame">
      <Frame25 />
      <Frame26 />
    </div>
  );
...
function Frame57() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[137px] px-0 py-[2px] rounded-[20px] top-[182px] w-[72px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.6)] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[10px] text-black text-nowrap">John</p>
    </div>
  );
}
...
function Frame34() {
  return (
    <div className="h-[217px] overflow-clip relative rounded-[20px] shrink-0 w-[225px]">
...
function Frame58() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[137px] px-0 py-[2px] rounded-[20px] top-[182px] w-[72px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.6)] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[10px] text-black text-nowrap">Elizabeth</p>
    </div>
  );
}
...
function Frame59() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[137px] px-0 py-[2px] rounded-[20px] top-[182px] w-[72px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.6)] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[10px] text-black text-nowrap">Franklin</p>
    </div>
  );
}
...
function Frame65() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[137px] px-0 py-[2px] rounded-[20px] top-[182px] w-[72px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.6)] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[10px] text-black text-nowrap">Naomi</p>
    </div>
  );
}
...
function Frame75() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[137px] px-0 py-[2px] rounded-[20px] top-[182px] w-[72px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.6)] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[10px] text-black text-nowrap">Zendaya</p>
    </div>
  );
}
...
function Frame85() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[137px] px-0 py-[2px] rounded-[20px] top-[182px] w-[72px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.6)] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[10px] text-black text-nowrap">Rahul</p>
    </div>
  );
}
...
export default function CollaborativeModeIfPinnedSomebody() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode - If Pinned Somebody">
      <Frame1 />
      <Frame55 />
      <Frame50 />
      <Frame54 />
