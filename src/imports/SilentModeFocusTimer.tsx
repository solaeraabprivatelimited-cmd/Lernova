import svgPaths from "./svg-734xismd1b";
...
export default function SilentModeFocusTimer() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Silent Mode - Focus Timer">
      <Frame1 />
      <Frame23 />
      <FocusTimer1 />
    </div>
