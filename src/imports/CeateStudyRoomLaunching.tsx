import svgPaths from "./svg-nahfl720ok";
...
function Frame8() {
  return (
    <div className="absolute content-stretch flex flex-col items-start leading-[normal] left-[318px] not-italic pb-[6px] top-[98px]">
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 text-[40px] text-black">Create Study Room</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.6)]">Build your own space to learn your way.</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex items-center left-[calc(50%+142.5px)] top-[calc(50%+19.5px)]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-black">Launching your room.......Please wait</p>
      <div className="relative shrink-0 size-[39px]" data-name="hourglass 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgHourglass1} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="temaki:room">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_2019_802)" id="temaki:room">
          <path d={svgPaths.p12a85400} fill="var(--fill-0, #003566)" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_2019_802">
  ...
  return (
    <div className="bg-[#c9e5ff] h-[42px] relative rounded-[10px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[6px] items-center px-[16px] relative size-full">
          <TemakiRoom />
          <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#003566] text-[14px]">Create Study Room</p>
        </div>
      </div>
    </div>
  );
...
export default function CeateStudyRoomLaunching() {
  return (
    <div className="bg-white relative size-full" data-name="Ceate Study Room - Launching">
      <Frame8 />
      <Frame13 />
