import svgPaths from "./svg-uyr4yv4a2i";
...
export default function LiveModeIfPinnedSomebody() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Live Mode - If Pinned Somebody">
      <Frame1 />
      <Frame55 />
      <Frame50 />
      <Frame54 />
