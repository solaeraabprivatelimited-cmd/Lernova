import svgPaths from "./svg-qm0hjrl00j";
...
function Frame70() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-start not-italic relative shrink-0 text-white w-full">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[normal] relative shrink-0 text-[24px] w-full">Kick Member</p>
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] relative shrink-0 text-[0px] w-full">
        <span className="text-[16px]">{`Are you sure you want to kick  `}</span>
        <span className="font-['Poppins:SemiBold',sans-serif] not-italic text-[18px] text-white">John</span>
        <span className="text-[16px]">{`  from this room`}</span>
      </p>
    </div>
  );
}
...
function Frame71() {
  return (
    <div className="basis-0 grow h-[42px] min-h-px min-w-px relative rounded-[20px] shrink-0">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center px-[35px] py-[3px] relative size-full">
          <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-nowrap text-white">No</p>
        </div>
      </div>
...
function Frame72() {
  return (
    <div className="basis-0 bg-[#ff5e5e] grow h-[42px] min-h-px min-w-px relative rounded-[20px] shrink-0">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center px-[35px] py-[3px] relative size-full">
          <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-nowrap text-white">{`Yes `}</p>
        </div>
      </div>
    </div>
  );
...
function ReportUser() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.1)] h-[218px] left-1/2 overflow-clip rounded-[20px] top-1/2 translate-x-[-50%] translate-y-[-50%] w-[436px]" data-name="Report User">
      <Frame74 />
    </div>
  );
}
...
export default function CollaborativeModeKickPerson() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode- Kick Person">
      <Frame1 />
      <Frame54 />
      <Frame50 />
      <ReportUser />
