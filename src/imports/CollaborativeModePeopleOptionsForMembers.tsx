import svgPaths from "./svg-pbo71dswme";
...
export default function CollaborativeModePeopleOptionsForMembers() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode - People - Options for Members">
      <Frame1 />
      <People />
      <Frame21 />
    </div>
