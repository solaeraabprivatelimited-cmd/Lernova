import svgPaths from "./svg-oe87t7dszb";
...
function Frame1() {
  return (
    <div className="absolute bg-[#c4c4c4] h-[716px] left-[32px] overflow-clip rounded-[20px] top-[66px] w-[868px]">
      ...
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[normal] left-[calc(50%-149px)] not-italic text-[32px] text-black text-nowrap top-[calc(50%-24px)]">Your Camera is off</p>
    </div>
  );
}
...
function VideoIcon() {
  return (
    <div className="relative shrink-0 size-[34px]" data-name="Video Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Video Icon">
          <path d={svgPaths.p35726a60} fill="var(--fill-0, #FF6969)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
export default function CollaborativeModeDisableVideo() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode - Disable Video">
      <Frame54 />
      <Frame1 />
      <Frame33 />
    </div>
