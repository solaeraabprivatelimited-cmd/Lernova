import svgPaths from "./svg-7o8zk9hbaa";
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[55px] items-start leading-[normal] not-italic relative shrink-0 text-black w-full">
      <p className="css-ew64yg font-['Poppins:Regular',sans-serif] relative shrink-0 text-[16px]">A payment request has been sent to the below UPI ID:</p>
      <p className="css-ew64yg font-['Poppins:SemiBold',sans-serif] relative shrink-0 text-[14px]">andrew@sbiybl</p>
    </div>
  );
}
...
function Group4() {
  return (
    <div className="absolute inset-[6.25%_6.25%_0.77%_6.25%]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 29.7526">
        <g id="Group">
          <g id="Vector"></g>
          <path clipRule="evenodd" d={svgPaths.p104fa280} fill="var(--fill-0, black)" fillRule="evenodd" id="Vector_2" opacity="0.1" />
          <path clipRule="evenodd" d={svgPaths.p1eff300} fill="var(--fill-0, black)" fillRule="evenodd" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
...
function MingcuteLoading3Fill() {
  return (
    <div className="overflow-clip relative shrink-0 size-[32px]" data-name="mingcute:loading-3-fill">
      <Group4 />
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="content-stretch flex gap-[16px] items-center justify-center relative shrink-0">
      <p className="css-ew64yg font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-black">Processing the payment</p>
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start p-[24px] relative shrink-0 w-[640px]">
      <p className="css-4hzbpn font-['Poppins:Medium',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[24px] text-black w-[min-content]">UPI Payment</p>
      <Frame11 />
      <Frame17 />
    </div>
  );
...
function Payment() {
  return (
    <div className="absolute bg-white content-stretch flex items-start left-1/2 overflow-clip p-[10px] rounded-[20px] shadow-[0px_4px_50px_5px_rgba(0,0,0,0.1)] top-[calc(50%+0.5px)] translate-x-[-50%] translate-y-[-50%] w-[502px]" data-name="Payment">
      <Frame16 />
    </div>
  );
}

export default function HumanMentorPaymentSuccessful() {
  return (
    <div className="relative size-full" data-name="Human Mentor - Payment Successful" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Frame13 />
      <Frame12 />
      <Frame8 />
