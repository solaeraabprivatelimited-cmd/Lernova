import svgPaths from "./svg-b2ma647ftl";
...
export default function PostNewArticle() {
  return (
    <div className="relative size-full" data-name="Post New Article" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Frame23 />
      <Frame31 />
      <Frame32 />
      <PostNewArticle1 />
