import svgPaths from "./svg-jyzb1j2nf1";
...
function Frame15() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-start left-[318px] overflow-clip px-[24px] py-[12px] rounded-[12px] shadow-[0px_4px_60px_5px_rgba(0,0,0,0.15)] top-[189px] w-[1058px]">
      <Frame17 />
    </div>
  );
}
...
function Card() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-center overflow-clip pb-[24px] pt-0 px-0 relative rounded-[20px] shadow-[0px_4px_50px_5px_rgba(0,0,0,0.1)] shrink-0 w-[326px]" data-name="Card">
      <Frame24 />
    </div>
  );
}
...
function Card2() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[560px] items-start justify-center overflow-clip pb-[24px] pt-0 px-0 relative rounded-[20px] shadow-[0px_4px_50px_5px_rgba(0,0,0,0.1)] shrink-0 w-[326px]" data-name="Card">
      <Frame39 />
    </div>
  );
}
...
export default function HumanMentorHome() {
  return (
    <div className="bg-white relative size-full" data-name="Human Mentor - Home">
      <Frame16 />
      <Frame15 />
      <Frame18 />
      <Frame14 />
