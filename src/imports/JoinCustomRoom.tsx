import svgPaths from "./svg-vn7uxip5s8";
...
function Frame8() {
  return (
    <div className="absolute content-stretch flex flex-col items-start leading-[normal] left-[318px] not-italic pb-[6px] pt-0 px-0 top-[122px] w-[437px]">
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 text-[40px] text-black text-nowrap">Join Custom Room</p>
      <p className="font-['Poppins:Regular',sans-serif] min-w-full relative shrink-0 text-[14px] text-[rgba(0,0,0,0.6)] w-[min-content]">Enter a Room ID or link to join your session.</p>
    </div>
  );
}
    ...
    <div className="h-[39px] relative rounded-[10px] shrink-0 w-full" data-name="Email Typist">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[10px] py-0 relative size-full">
          <CilRoom />
          <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.6)] text-nowrap">Enter Room ID or Paste Room Link</p>
        </div>
      </div>
    </div>
  );
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-nowrap">Room ID / Link</p>
      <EmailTypist />
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="basis-0 bg-[#003566] content-stretch flex grow h-[42px] items-center justify-center min-h-px min-w-px relative rounded-[20px] shrink-0">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-nowrap text-white">Enter Room</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[154px]">
      <Frame13 />
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-start justify-center left-[calc(50%+109.5px)] overflow-clip p-[24px] rounded-[20px] shadow-[0px_4px_50px_5px_rgba(0,0,0,0.1)] top-[369px] translate-x-[-50%]">
      <Frame15 />
    </div>
  );
}
...
export default function JoinCustomRoom() {
  return (
    <div className="bg-white relative size-full" data-name="Join Custom Room">
