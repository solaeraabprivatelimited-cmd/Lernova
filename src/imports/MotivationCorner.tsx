import svgPaths from "./svg-22pgop4ljw";
...
function Frame20() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#003566] text-[24px] w-full whitespace-pre-wrap">Motivational Quote</p>
    </div>
  );
}
...
export default function MotivationCorner() {
  return (
    <div className="bg-white relative size-full" data-name="Motivation Corner">
