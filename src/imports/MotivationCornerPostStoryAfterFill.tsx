import svgPaths from "./svg-lqbdnhvtlu";
  ...
  return (
    <div className="bg-white relative rounded-[10px] shadow-[0px_4px_29.4px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Email Typist">
      <div className="content-stretch flex items-start justify-between p-[16px] relative w-full">
        <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.8)]">Story</p>
        <Arrow />
      </div>
    </div>
  );
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px relative">
      <p className="flex-[1_0_0] font-['Poppins:Medium',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[16px] text-[rgba(0,0,0,0.6)] whitespace-pre-wrap">Lorem ipsum dolor sit amet consectetur. Malesuada morbi faucibus ut pellentesque proin lorem. Blandit venenatis ante in dolor nisl mauris nisl hac donec.</p>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="bg-white content-stretch flex h-[327px] items-start p-[16px] relative rounded-[10px] shadow-[0px_4px_29.4px_0px_rgba(0,0,0,0.1)] shrink-0 w-[570px]">
      <Frame16 />
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-[570px]">
      <Pic />
      <LetsIconsAddDuotone />
    </div>
  );
...
function Frame14() {
  return (
    <div className="bg-[#003566] content-stretch flex flex-[1_0_0] h-[42px] items-center justify-center min-h-px min-w-px relative rounded-[20px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-white">Post Story</p>
    </div>
  );
}
...
export default function MotivationCornerPostStoryAfterFill() {
  return (
    <div className="bg-white relative size-full" data-name="Motivation Corner - Post Story (After Fill)">
