import svgPaths from "./svg-zk5lotdlth";
...
function Group2() {
  return (
    <div className="h-[32.989px] relative w-[31.8px]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.7998 32.9888">
        <g id="Group">
          <path d={svgPaths.p21f5bd00} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p3e025500} fill="var(--fill-0, white)" id="Vector_2" />
          <path d={svgPaths.p35be3300} fill="var(--fill-0, white)" id="Vector_3" />
          <path d={svgPaths.pb0ba010} fill="var(--fill-0, white)" id="Vector_4" />
          <path d={svgPaths.p3eda0b80} fill="var(--fill-0, white)" id="Vector_5" />
        </g>
      </svg>
    </div>
  );
...
function Frame25() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex items-center justify-center relative rounded-[20px] shrink-0 size-[70px]">
...
export default function CollaborativeModeNotes() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode - Notes">
      <Frame1 />
      <Component />
      <Frame23 />
    </div>
