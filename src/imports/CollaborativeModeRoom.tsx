import svgPaths from "./svg-bt7ysndv5u";
...
export default function CollaborativeModeRoom() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode Room">
      <Frame1 />
      <Frame54 />
      <Frame33 />
      <Frame50 />
