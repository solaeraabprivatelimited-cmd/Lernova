import svgPaths from "./svg-mw4zc0ea46";
...
function Group4() {
  return (
    <div className="h-[243.099px] relative shrink-0 w-[254px]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 254 243.099">
        <g id="Group">
          <path d={svgPaths.p6221200} fill="var(--fill-0, #FF5E5E)" id="Vector" />
          <path d={svgPaths.p2d915c70} fill="var(--fill-0, white)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Frame12() {
  return (
    <div className="bg-[#003566] content-stretch flex h-[42px] items-center justify-center relative rounded-[20px] shrink-0 w-[156px]">
      <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-white">Try Again</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center p-[24px] relative shrink-0 w-[640px]">
      <p className="css-4hzbpn font-['Poppins:SemiBold',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[24px] text-black w-[min-content]">Payment Failed</p>
      <Group4 />
      <p className="css-4hzbpn font-['Poppins:Medium',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[20px] text-black text-center w-[min-content]">Something went wrong while processing your payment.</p>
      <p className="css-4hzbpn font-['Poppins:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[16px] text-black text-center w-[min-content]">
        Please try again or use a different payment method.
        <br aria-hidden="true" />
        {` Your session hasn’t been booked yet`}
      </p>
      <Frame12 />
    </div>
  );
...
function Payment() {
  return (
    <div className="absolute bg-white content-stretch flex items-start left-1/2 overflow-clip p-[24px] rounded-[20px] shadow-[0px_4px_50px_5px_rgba(0,0,0,0.1)] top-[calc(50%-0.45px)] translate-x-[-50%] translate-y-[-50%]" data-name="Payment">
      <Frame16 />
    </div>
  );
}

export default function HumanMentorPaymentFailed() {
  return (
    <div className="relative size-full" data-name="Human Mentor - Payment Failed" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Frame13 />
      <Frame11 />
      <Frame8 />
