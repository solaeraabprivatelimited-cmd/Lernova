import svgPaths from "./svg-ls5hyqprrg";
...
function Pin() {
  return (
    <div className="relative shrink-0 size-[34px]" data-name="Pin">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="hugeicons:pin">
          <rect fill="var(--fill-0, white)" fillOpacity="0.1" height="34" rx="17" width="34" />
          <path d={svgPaths.p20138d00} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
...
function Frame63() {
  return (
    <div className="content-stretch flex h-[217px] items-start overflow-clip p-[12px] relative rounded-[20px] shrink-0 w-[225px]">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[20px]">
...
function IcOutlineLaptop() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ic:outline-laptop">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ic:outline-laptop">
          <path d={svgPaths.p24e5a180} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame65() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
      <IcOutlineLaptop />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-nowrap text-white">Your Entire Screen</p>
    </div>
  );
}

function HeroiconsWindow16Solid() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="heroicons:window-16-solid">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="heroicons:window-16-solid">
          <path clipRule="evenodd" d={svgPaths.pddf5c00} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame66() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
      <HeroiconsWindow16Solid />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-nowrap text-white">A Window</p>
    </div>
  );
}

function MaterialSymbolsTabOutline() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="material-symbols:tab-outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="material-symbols:tab-outline">
          <path d={svgPaths.p12ad800} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame67() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
      <MaterialSymbolsTabOutline />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-nowrap text-white">A Tab</p>
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.1)] content-stretch flex flex-col gap-[12px] items-start justify-center left-[714px] overflow-clip pl-[24px] pr-[66px] py-[9px] rounded-[20px] top-[645px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-nowrap text-white">Present</p>
      <Frame65 />
      <Frame66 />
      <Frame67 />
    </div>
...
export default function CollaborativeModeScreenShare() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode - Screen Share">
      <Frame50 />
      <Frame33 />
      <Frame1 />
      <Frame54 />
