import svgPaths from "./svg-urhtyi79ya";
    ...
    <div className="relative shrink-0 size-[24px]" data-name="flowbite:globe-outline">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="flowbite:globe-outline">
          <path d={svgPaths.p39188800} id="Vector" stroke="var(--stroke-0, #003566)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="bg-[#c9e5ff] h-[42px] relative rounded-[10px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[6px] items-center px-[16px] relative size-full">
          ...
          <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#003566] text-[14px]">World Chat</p>
        </div>
      </div>
    </div>
  );
...
function Frame9() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[318px] top-[98px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[40px] text-black">World Chat</p>
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="absolute content-stretch flex gap-[20px] items-center left-[318px] top-[806px] w-[1082px]">
      <Frame20 />
      <Frame21 />
    </div>
  );
...
export default function WorldChatReport() {
  return (
    <div className="bg-white relative size-full" data-name="World Chat - Report">
