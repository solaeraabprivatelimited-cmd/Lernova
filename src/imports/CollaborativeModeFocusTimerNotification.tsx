import svgPaths from "./svg-lgi84qjj21";
...
export default function CollaborativeModeFocusTimerNotification() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode - Focus Timer Notification">
      <Frame1 />
      <Frame15 />
    </div>
  );
