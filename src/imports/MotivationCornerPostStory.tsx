import svgPaths from "./svg-wmk6nszp1j";
...
function Frame16() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.6)]">Type in your story here</p>
    </div>
  );
}
...
function Frame38() {
  return (
    <div className="h-[40px] relative shrink-0 w-[570px]">
      <Frame17 />
    </div>
  );
}
...
export default function MotivationCornerPostStory() {
  return (
    <div className="bg-white relative size-full" data-name="Motivation Corner - Post Story">
