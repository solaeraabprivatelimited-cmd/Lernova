import svgPaths from "./svg-ueklvv1xsb";
...
export default function CollaborativeModeRoomSilentNotifications() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode Room - Silent Notifications">
      <Frame1 />
      <Frame54 />
      <Frame33 />
      <Frame50 />
