import svgPaths from "./svg-rl2tagxg31";
...
export default function SilentModeReaction() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Silent Mode- Reaction">
      <Frame1 />
      <Frame54 />
      <Frame33 />
      <Frame50 />
