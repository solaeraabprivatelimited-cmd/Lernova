import svgPaths from "./svg-y4041d0k6z";
...
function Frame16() {
  return (
    <div className="absolute h-[358px] left-[1410px] overflow-clip rounded-[20px] top-1/2 translate-y-[-50%] w-[6px]">
      <Frame14 />
      <Frame15 />
    </div>
  );
    ...
    <div className="absolute inset-[16.67%]" data-name="Group">
      <div className="absolute inset-[-6.25%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
          <g id="Group">
            <path d={svgPaths.p36395980} id="Vector" stroke="var(--stroke-0, black)" strokeLinejoin="round" strokeOpacity="0.8" strokeWidth="2" />
            <path d={svgPaths.p372d2a00} id="Vector_2" stroke="var(--stroke-0, black)" strokeOpacity="0.8" strokeWidth="2" />
          </g>
        </svg>
      </div>
    </div>
...
function Frame32() {
  return (
    <div className="bg-[#e5e7eb] content-stretch flex items-center justify-center relative rounded-[4px] shrink-0 size-[27px]">
      <IconamoonProfile />
    </div>
  );
}
...
function Frame33() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0">
      <Frame32 />
      <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.8)]">Ravi Kumar</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-white relative rounded-[10px] shadow-[0px_4px_29.4px_0px_rgba(0,0,0,0.1)] shrink-0 w-full">
      <div className="content-stretch flex items-start justify-between p-[16px] relative w-full">
        <Frame33 />
        <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.8)]">₹500/hr</p>
      </div>
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.8)]">Available Date and Time Slots</p>
    </div>
  );
}
...
function EmailTypist() {
  return (
    <div className="content-stretch flex h-[39px] items-center px-[10px] py-0 relative rounded-[10px] shrink-0" data-name="Email Typist">
      ...
      <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.8)]">18-10-25 | 7:00 PM</p>
    </div>
  );
}
...
function EmailTypist1() {
  return (
    <div className="content-stretch flex h-[39px] items-center px-[10px] py-0 relative rounded-[10px] shrink-0" data-name="Email Typist">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.8)]">22-10-25 | 6:00 PM</p>
    </div>
  );
}
...
function EmailTypist2() {
  return (
    <div className="content-stretch flex h-[39px] items-center px-[10px] py-0 relative rounded-[10px] shrink-0" data-name="Email Typist">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.8)]">25-10-25 | 8:00 PM</p>
    </div>
  );
}

function DateAndTimeSlots() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[467px]" data-name="Date and Time Slots">
      <Frame24 />
      <Frame11 />
      <EmailTypist2 />
    </div>
...
function Frame25() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.8)]">Number of Hours</p>
    </div>
  );
}
...
function EmailTypist3() {
  return (
    <div className="content-stretch flex h-[39px] items-center px-[10px] py-0 relative rounded-[10px] shrink-0" data-name="Email Typist">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.8)]">1 hour</p>
    </div>
  );
}
...
function EmailTypist4() {
  return (
    <div className="content-stretch flex h-[39px] items-center px-[10px] py-0 relative rounded-[10px] shrink-0" data-name="Email Typist">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.8)]">2 hours</p>
    </div>
  );
}

function EmailTypist5() {
  return (
    <div className="content-stretch flex h-[39px] items-center px-[10px] py-0 relative rounded-[10px] shrink-0" data-name="Email Typist">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.8)]">3 hours</p>
    </div>
  );
}
...
function NoOfHours() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[467px]" data-name="No of Hours">
      <Frame25 />
      <Frame12 />
    </div>
  );
...
function Frame19() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-[337px]">
      <Frame17 />
      <Frame18 />
    </div>
  );
...
function Frame20() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-end relative shrink-0 w-[467px]">
      <p className="css-4hzbpn font-['Poppins:SemiBold',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[24px] text-black w-[min-content]">Book a Session</p>
      <Frame34 />
      <DateAndTimeSlots />
      <NoOfHours />
      <Frame19 />
...
function BookASession() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-start justify-center left-[calc(50%-0.5px)] overflow-clip p-[32px] rounded-[20px] shadow-[0px_4px_50px_5px_rgba(0,0,0,0.1)] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="Book a Session">
      <Frame20 />
    </div>
  );
}

export default function HumanMentorBookASession() {
  return (
    <div className="relative size-full" data-name="Human Mentor - Book a Session" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Frame21 />
      <Frame16 />
      <Frame13 />
      <Frame8 />
