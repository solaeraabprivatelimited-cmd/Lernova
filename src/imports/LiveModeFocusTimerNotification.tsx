import svgPaths from "./svg-qj5iixv53r";
...
export default function LiveModeFocusTimerNotification() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Live Mode - Focus Timer Notification">
      <Frame1 />
      <Frame15 />
    </div>
  );
