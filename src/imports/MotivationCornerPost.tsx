import svgPaths from "./svg-npqpbayjjr";
...
export default function MotivationCornerPost() {
  return (
    <div className="bg-white relative size-full" data-name="Motivation Corner - Post">
