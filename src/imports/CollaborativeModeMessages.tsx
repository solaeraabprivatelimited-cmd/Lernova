import svgPaths from "./svg-10iypj6y9t";
...
import imgEllipse2 from "figma:asset/aa7dd42ba4e60430a73263951463923310b39850.png";
...
function IconamoonSendLight() {
  return (
    <div className="relative shrink-0 size-[27px]" data-name="iconamoon:send-light">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 27 27">
        <g id="iconamoon:send-light">
          <path d={svgPaths.p32da680} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame11() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.1)] content-stretch flex items-center justify-between left-[32px] overflow-clip px-[24px] py-[16px] rounded-[20px] top-[641px] w-[390px]">
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(255,255,255,0.6)] text-nowrap">Type your message here</p>
      <IconamoonSendLight />
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-end relative shrink-0 w-full">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[24px] text-white w-[368px]">Messages</p>
...
function Frame16() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] h-[40px] relative rounded-[20px] shrink-0 w-full">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[24px] py-[16px] relative size-full">
          <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-nowrap text-white">Hey, there everyone</p>
        </div>
      </div>
    </div>
  );
...
function Frame22() {
  return (
    <div className="content-stretch flex flex-col gap-[3px] items-start relative shrink-0 w-[344px]">
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.6)] w-full">
...
function Frame17() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] h-[40px] relative rounded-[20px] shrink-0 w-full">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[24px] py-[16px] relative size-full">
          <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-nowrap text-white">Hello</p>
        </div>
      </div>
    </div>
  );
...
function Frame27() {
  return (
    <div className="content-stretch flex flex-col gap-[3px] items-end relative shrink-0 w-[344px]">
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.6)] text-nowrap">
...
function Frame25() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[32px] top-[16px] w-[410px]">
      <Frame12 />
      <Frame26 />
    </div>
  );
...
function GrommetIconsChat() {
  return (
    <div className="h-[28px] relative w-[29px]" data-name="grommet-icons:chat">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 29 28">
        <g clipPath="url(#clip0_16_3874)" id="grommet-icons:chat">
          <path d={svgPaths.p3307200} id="Vector" stroke="var(--stroke-0, white)" strokeWidth="2" />
        </g>
        <defs>
...
export default function CollaborativeModeMessages() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode - Messages">
      <Frame1 />
      <Component />
      <Frame19 />
    </div>
