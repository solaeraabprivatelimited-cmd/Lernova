import svgPaths from "./svg-lhcndldprh";
...
export default function JoinCustomRoomJoiningRoom() {
  return (
    <div className="bg-white relative size-full" data-name="Join Custom Room - Joining Room">
