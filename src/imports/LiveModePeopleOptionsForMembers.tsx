import svgPaths from "./svg-q0bqeyfgki";
...
function Frame30() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-center left-[266px] top-[11.5px] w-[60px]">
      <PinUnpin />
      <Mic />
      <MiOptionsVertical />
    </div>
...
export default function LiveModePeopleOptionsForMembers() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Live Mode - People - Options for Members">
      <Frame1 />
      <People />
      <Frame21 />
    </div>
