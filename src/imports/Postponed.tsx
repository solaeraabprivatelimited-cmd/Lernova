import svgPaths from "./svg-y817hbsh6g";
...
function Frame19() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] h-[42px] items-center justify-center min-h-px min-w-px relative rounded-[20px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-black">Postponed</p>
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="content-stretch flex h-[42px] items-center relative rounded-[20px] shrink-0 w-[227px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(0,0,0,0.8)]">New Session Date and Time</p>
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="content-stretch flex h-[42px] items-center relative rounded-[20px] shrink-0 w-[227px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(0,0,0,0.8)]">Old Session Date and Time</p>
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[42px] items-center justify-center min-h-px min-w-px relative rounded-[20px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(0,0,0,0.8)]">Status</p>
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="content-stretch flex h-[42px] items-center relative rounded-[20px] shrink-0 w-[227px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-black">{`30/10/25  |  9:00PM`}</p>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[42px] items-center justify-center min-h-px min-w-px relative rounded-[20px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#003566] text-[12px]">Postponed</p>
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="content-stretch flex h-[42px] items-center relative rounded-[20px] shrink-0 w-[227px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-black">{`29/10/25  |  5:00PM`}</p>
    </div>
  );
}
...
export default function Postponed() {
  return (
    <div className="bg-white relative size-full" data-name="Postponed">
      <Frame38 />
      <Frame41 />
      <Frame8 />
