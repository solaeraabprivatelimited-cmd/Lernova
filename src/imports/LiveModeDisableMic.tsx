import svgPaths from "./svg-si26mjaxur";
...
export default function LiveModeDisableMic() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Live Mode - Disable Mic">
      <Frame1 />
      <Frame54 />
      <Frame33 />
      <Frame50 />
