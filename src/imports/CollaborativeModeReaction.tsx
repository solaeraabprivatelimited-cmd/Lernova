import svgPaths from "./svg-jgn3790qov";
...
export default function CollaborativeModeReaction() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode- Reaction">
      <Frame1 />
      <Frame54 />
      <Frame50 />
      <Recations />
