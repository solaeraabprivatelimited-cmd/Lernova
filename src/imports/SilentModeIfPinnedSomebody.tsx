import svgPaths from "./svg-orgwtqgm0j";
...
export default function SilentModeIfPinnedSomebody() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Silent Mode - If Pinned Somebody">
      <Frame1 />
      <Frame55 />
      <Frame33 />
      <Frame50 />
