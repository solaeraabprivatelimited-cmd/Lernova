import svgPaths from "./svg-hwha0ux6uy";
...
export default function SilentModeDisableVideo() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Silent Mode - Disable Video">
      <Frame33 />
      <Frame54 />
      <Frame1 />
    </div>
