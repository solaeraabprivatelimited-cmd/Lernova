import svgPaths from "./svg-u62kuem5a7";
...
function Fa7RegularSmileBeam() {
  return (
    <div className="h-[68px] relative shrink-0 w-[65px]" data-name="fa7-regular:smile-beam">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 65 68">
        <g id="fa7-regular:smile-beam">
          <rect fill="var(--fill-0, white)" fillOpacity="0.1" height="68" rx="20" width="65" />
          <path d={svgPaths.p9024040} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Recations() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.1)] content-stretch flex gap-[16px] items-center left-[calc(50%+87px)] overflow-clip px-[46px] py-[23px] rounded-[20px] top-[calc(50%+314px)] translate-x-[-50%] translate-y-[-50%]" data-name="Recations">
      <Heart24 />
      <ThumbsUp />
      <Clap />
      <Celebration />
...
export default function SilentModeOnReaction() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Silent Mode- On Reaction">
      <Frame1 />
      <Frame54 />
      <Frame33 />
      <Frame50 />
