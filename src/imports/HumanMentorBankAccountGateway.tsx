import svgPaths from "./svg-hapileda00";
...
function Frame16() {
  return (
    <div className="content-stretch flex gap-[16px] items-center justify-center relative shrink-0">
      <p className="css-ew64yg font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-black">Heading towards payment gateway</p>
...
function Frame15() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start p-[24px] relative shrink-0 w-[378px]">
      <p className="css-4hzbpn font-['Poppins:Medium',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[24px] text-black w-[min-content]">Bank Payment</p>
      <Frame16 />
    </div>
  );
}
...
function Payment() {
  return (
    <div className="absolute bg-white content-stretch flex items-start left-1/2 overflow-clip p-[10px] rounded-[20px] shadow-[0px_4px_50px_5px_rgba(0,0,0,0.1)] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="Payment">
      <Frame15 />
    </div>
  );
}

export default function HumanMentorBankAccountGateway() {
  return (
    <div className="relative size-full" data-name="Human Mentor - Bank Account Gateway" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Frame12 />
      <Frame11 />
      <Frame8 />
