import svgPaths from "./svg-jpnz6y9zk5";
...
function SvgRepoIconCarrier() {
  return (
    <div className="h-[32.002px] relative shrink-0 w-[29.538px]" data-name="SVGRepo_iconCarrier">
      <div className="absolute inset-[-2.5%_-2.71%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.1385 33.6">
          <g id="SVGRepo_iconCarrier">
            <path d={svgPaths.p24cea7e0} id="Vector" stroke="var(--stroke-0, #FF5E5E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" />
            <path d={svgPaths.p335f1080} id="Vector_2" stroke="var(--stroke-0, #FF5E5E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" />
            <path d={svgPaths.p33ea1500} id="Vector_3" stroke="var(--stroke-0, #FF5E5E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" />
            <path d="M30.3385 31.5692L0.8 2.03077" id="Vector_4" stroke="var(--stroke-0, #FF5E5E)" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="1.6" />
          </g>
        </svg>
      </div>
    </div>
...
function Frame75() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[137px] px-0 py-[2px] rounded-[20px] top-[182px] w-[72px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.6)] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[10px] text-black text-nowrap">Steve</p>
    </div>
  );
}
...
export default function SilentModeBlockNotifications() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Silent Mode - Block Notifications">
      <Frame33 />
      <Frame50 />
      <Frame1 />
      <Frame54 />
