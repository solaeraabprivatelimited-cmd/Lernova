import svgPaths from "./svg-ocfy1ulm94";
...
function EmailTypist() {
  return (
    <div className="content-stretch flex h-[39px] items-center px-[10px] py-0 relative rounded-[10px] shrink-0" data-name="Email Typist">
      <div aria-hidden="true" className="absolute border-2 border-[#003566] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-black">18-10-25 | 7:00 PM</p>
    </div>
  );
}
...
function EmailTypist3() {
  return (
    <div className="content-stretch flex h-[39px] items-center px-[10px] py-0 relative rounded-[10px] shrink-0" data-name="Email Typist">
      <div aria-hidden="true" className="absolute border-2 border-[#003566] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <p className="css-ew64yg font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-black">1 hour</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="content-stretch flex gap-[24px] items-center justify-center relative shrink-0 w-[352px]">
      <Frame14 />
      <Frame15 />
    </div>
  );
...
export default function HumanMentorBookASessionUponSelection() {
  return (
    <div className="relative size-full" data-name="Human Mentor - Book a Session (Upon Selection)" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Frame18 />
      <Frame13 />
      <Frame8 />
