import svgPaths from "./svg-ptpt27ssea";
  ...
  return (
    <div className="relative shrink-0 size-[28px]" data-name="Mic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
        <g id="Mic">
          <path d={svgPaths.p2b469100} fill="var(--fill-0, #FF5E5E)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
export default function CollaborativeModeDisableMic() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Collaborative Mode - Disable Mic">
      <Frame1 />
      <Frame54 />
      <Frame33 />
      <Frame50 />
