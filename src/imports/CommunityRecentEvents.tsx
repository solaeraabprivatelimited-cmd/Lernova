import svgPaths from "./svg-27jejpizs0";
...
function Frame30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[318px] top-[784px] w-[1082px]">
      <Frame26 />
      <Frame31 />
      <Frame46 />
    </div>
...
export default function CommunityRecentEvents() {
  return (
    <div className="bg-white relative size-full" data-name="Community - Recent Events">
