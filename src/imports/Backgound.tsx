import svgPaths from "./svg-q6b7x81oeo";
...
function Frame11() {
  return (
    <div className="bg-[#ccc] h-[156px] overflow-clip relative rounded-[20px] shrink-0 w-[278px]">
      <div className="absolute h-[157px] left-0 top-0 w-[278px]" data-name="Screenshot (11) 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-full left-0 max-w-none top-0 w-[200.84%]" src={imgScreenshot111} />
        </div>
      </div>
...
function Frame12() {
  return (
    <div className="bg-[#ccc] h-[156px] overflow-clip relative rounded-[20px] shrink-0 w-[278px]">
      <div className="absolute h-[155px] left-[-4px] top-0 w-[282px]" data-name="image 29">
...
function Frame13() {
  return (
    <div className="bg-[#ccc] h-[156px] overflow-clip relative rounded-[20px] shrink-0 w-[278px]">
      <div className="absolute h-[157px] left-0 top-0 w-[278px]" data-name="Screenshot (11) 1" />
      <div className="absolute h-[156px] left-[-3px] top-0 w-[281px]" data-name="image 30">
...
function Frame14() {
  return (
    <div className="bg-[#ccc] h-[156px] overflow-clip relative rounded-[20px] shrink-0 w-[278px]">
      <div className="absolute h-[156px] left-px top-0 w-[277px]" data-name="image 31">
...
function BackgroundOvelray() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.1)] content-stretch flex gap-[16px] items-center left-[calc(50%+22px)] overflow-clip p-[30px] rounded-[20px] top-[580px] translate-x-[-50%]" data-name="Background Ovelray">
      <Frame11 />
      <Frame12 />
      <Frame13 />
      <Frame14 />
  ...
  return (
    <div className="relative shrink-0 size-[44px]" data-name="Background">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 44">
        <g id="Background">
          <path d={svgPaths.p3de58900} fill="var(--fill-0, white)" id="Vector" />
          <path clipRule="evenodd" d={svgPaths.p103a8e00} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector_2" />
          <path d={svgPaths.p239d3480} fill="var(--fill-0, white)" id="Vector_3" opacity="0.5" />
        </g>
      </svg>
    </div>
  );
...
function Background1() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex items-center justify-center overflow-clip relative rounded-[20px] shrink-0 size-[70px]" data-name="Background">
      <Background />
    </div>
  );
}
...
export default function Backgound() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Backgound">
      <Frame1 />
      <BackgroundOvelray />
      <Frame15 />
    </div>
