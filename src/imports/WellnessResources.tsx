import svgPaths from "./svg-w1ctq7f27e";
...
function Frame22() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[24px] items-start left-[318px] p-[24px] rounded-[20px] shadow-[0px_4px_50px_0px_rgba(0,0,0,0.1)] top-[571px] w-[1082px]">
      <Frame23 />
      <Frame24 />
      <Frame25 />
    </div>
...
export default function WellnessResources() {
  return (
    <div className="bg-white relative size-full" data-name="Wellness Resources">
