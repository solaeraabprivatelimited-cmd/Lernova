import svgPaths from "./svg-c7y5awxkzp";
    ...
    <div className="absolute inset-[8.33%]" data-name="Group">
      <div className="absolute inset-[-4.62%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23.6667 23.6667">
          <g id="Group">
            <path d={svgPaths.p293e800} id="Vector" stroke="var(--stroke-0, black)" strokeLinejoin="round" strokeWidth="2" />
            <path d={svgPaths.p21de0180} id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </g>
        </svg>
      </div>
    </div>
...
function IconParkOutlineCloseOne() {
  return (
    <div className="overflow-clip relative shrink-0 size-[26px]" data-name="icon-park-outline:close-one">
      <Group />
    </div>
  );
}
...
function Frame61() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[10px] items-center justify-center left-0 overflow-clip p-[16px] rounded-br-[20px] rounded-tr-[20px] top-[33px] w-[291px]">
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[0px] text-[16px] text-black text-nowrap">
        <span>{`Successfully reported `}</span>
        <span className="font-['Poppins:SemiBold',sans-serif] text-[#ff5e5e]">John</span>
      </p>
...
export default function SilentModePostReportNotification() {
  return (
    <div className="bg-[#141316] relative size-full" data-name="Silent Mode- Post Report Notification">
      <Frame1 />
      <Frame54 />
      <Frame33 />
      <Frame50 />
